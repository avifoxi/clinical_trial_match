namespace :importer do
    ...
    desc "Task for Heroku Scheduler to import 5 trials"
    task :import_few_trials => :environment do
        require 'nokogiri'
        require 'rest-client'
        require 'uri'
    ...
    desc "Task for Heroku Scheduler to import trials"
    task :import_all_trials => :environment do
        require 'nokogiri'
        require 'rest-client'
        require 'uri'
